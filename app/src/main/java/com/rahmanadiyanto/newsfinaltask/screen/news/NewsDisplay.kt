...
import com.rahmanadiyanto.newsfinaltask.ui.theme.TransparentBlack_x67
import com.rahmanadiyanto.newsfinaltask.ui.theme.TransparentBlack_x87
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                title = { Text(text = "News Education", color = TransparentWhite_x87) }
            )
        }) { padding ->
        Surface(
            modifier = Modifier
